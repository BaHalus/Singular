...
function createSummary(projection) {
  return {
    ...
    attributes: Object.values(projection.attributes).map(attribute => ({
      id: attribute.key,
      label: attribute.key,
      value: attribute.final ?? attribute.level,
      base: attribute.base,
