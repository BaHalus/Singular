...
test("spell edit mount detaches only its own listener", () => {
  ...
  const app = {
    character: Object.freeze({ spells: [] }),
    ...
    commands: Object.freeze({ updateSpell: () => Object.freeze({ status: "no-op" }) }),
    repositories: Object.freeze({}),
    runtime: Object.freeze({}),
    equipmentEdit: Object.freeze({ destroy() { previousDestroyCalls += 1; } }),
    render() {},
  };

  const mounted = mountCharacterMobileSpellEditApp(app, { root });
