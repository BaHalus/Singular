...
test("power edit mount detaches only its own listener", () => {
  ...
  const app = {
    character: Object.freeze({ powers: [] }),
    ...
    commands: Object.freeze({ renamePower: () => Object.freeze({ status: "no-op" }) }),
    repositories: Object.freeze({}),
    runtime: Object.freeze({}),
    spellEdit: Object.freeze({ destroy() { previousDestroyCalls += 1; } }),
    render() {},
  };

  const mounted = mountCharacterMobilePowerEditApp(app, { root });
